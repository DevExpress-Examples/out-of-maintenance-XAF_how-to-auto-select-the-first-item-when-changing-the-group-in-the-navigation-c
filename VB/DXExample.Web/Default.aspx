<%@ Page Language="vb" AutoEventWireup="true" Inherits="DefaultVertical" EnableViewState="false" validateRequest="false" Codebehind="Default.aspx.vb" %>
			...
			<tr class="Footer">
				...
				<td class="Right">
					<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr>
						...
						<td>
							<cc2:WrappedHorizontalActionContainer ID="DiagnosticActionContainer" runat="server"
